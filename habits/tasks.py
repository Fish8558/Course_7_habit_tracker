...
@shared_task
def check_habits_for_sending():
    """Проверка всех привычек, требуется ли отправка сообщения пользователю.
    После отправки сообщения, изменяется поле привычки next_date."""
